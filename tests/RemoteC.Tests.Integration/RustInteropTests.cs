...
// using RemoteC.Core.Interop; // TODO: Add when Rust core is built
using Xunit;
...
namespace RemoteC.Tests.Integration
{
    ...
    /// </summary>
    [Trait("Category", "RustInterop")]
    [Trait("Skip", "RustCoreNotBuilt")] // TODO: Remove when Rust core is built
    public class RustInteropTests_TODO // TODO: Rename back to RustInteropTests when ready : IDisposable
    {
        private bool _initialized;

        public RustInteropTests_TODO()
        {
            // Initialize Rust library
            // var result = RemoteCCore.remotec_init();
            // _initialized = result == 0;
            _initialized = false; // TODO: Set to true when Rust core is ready
        }
