...
namespace RemoteC.Api.Tests.Services
{
    public class ComplianceServiceTests : IDisposable
    {
        ...
        public async Task ProcessDataSubjectRequestAsync_RightToAccess_ReturnsUserData()
        {
            ...
            {
                UserId = userId,
                RequestType = RemoteC.Shared.Models.DataSubjectRequestType.Access,
            ...
            Assert.Equal(RemoteC.Shared.Models.DataSubjectRequestStatus.Completed, response.Status);
        ...
        public async Task ProcessDataSubjectRequestAsync_RightToErasure_AnonymizesData()
        {
            ...
            {
                UserId = userId,
                RequestType = RemoteC.Shared.Models.DataSubjectRequestType.Erasure,
        ...
        public async Task ProcessDataSubjectRequestAsync_RightToPortability_ExportsData()
        {
            ...
            {
                UserId = userId,
                RequestType = RemoteC.Shared.Models.DataSubjectRequestType.Portability,
                RequestedBy = "export@example.com",
                ExportFormat = RemoteC.Shared.Models.ExportFormat.Json
            };
