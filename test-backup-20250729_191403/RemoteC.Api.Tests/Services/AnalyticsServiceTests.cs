...
namespace RemoteC.Api.Tests.Services
{
    public class AnalyticsServiceTests : IDisposable
    {
        ...
        public async Task DetectPerformanceAnomaliesAsync_IdentifiesIssues()
        {
            ...
            Assert.Contains(anomalies, a => a.Type == RemoteC.Shared.Models.AnomalyType.LatencySpike);
            Assert.Contains(anomalies, a => a.Severity == RemoteC.Shared.Models.AnomalySeverity.High);
        ...
        public async Task ScheduleReportAsync_CreatesRecurringReport()
        {
            ...
            var report = new ScheduledReport
            {
                ...
                Type = RemoteC.Shared.Models.ReportType.Performance,
                Schedule = RemoteC.Shared.Models.ReportSchedule.Weekly,
        ...
        private async Task CreateSessionData(Guid organizationId, int count)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                sessions.Add(new Session
                {
                    ...
                    Status = (RemoteC.Data.Entities.SessionStatus)RemoteC.Shared.Models.SessionStatus.Ended
                });
            }
    ...
    // Removed duplicate enums - using RemoteC.Shared.Models enums
